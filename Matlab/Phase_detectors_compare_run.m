...
GWNPhase_Hilb = zeros([Length/DT+1-59,NoiseSteps]);
GWNWrappedPhase_Hilb = zeros([Length/DT+1-59,NoiseSteps]);
for k = 1:NoiseSteps
...
GWNPhase_Wave = zeros([Length/DT+1-59,NoiseSteps]);
GWNWrappedPhase_Wave = zeros([Length/DT+1-59,NoiseSteps]);
for k = 1:NoiseSteps
...
[Difference_Hilb1,MeanEst_Hilb1,MeanDiff_Hilb1,STDDiff_Hilb1] = BlandAltman(TDPhaseUnwrap(30:end-30),TDPhase_Hilb',GraphicBA);
[Difference_Wave1,MeanEst_Wave1,MeanDiff_Wave1,STDDiff_Wave1] = BlandAltman(TDPhaseUnwrap(30:end-30),TDPhase_Wave,GraphicBA);
% for the noise 
for k = 1:NoiseSteps
    [Difference_Hilb(:,k),MeanEst_Hilb(:,k),MeanDiff_Hilb(k),STDDiff_Hilb(k)] = BlandAltman(TDPhase(30:end-30),GWNWrappedPhase_Hilb(:,k)',GraphicBA); 
    [Difference_Wave(:,k),MeanEst_Wave(:,k),MeanDiff_Wave(k),STDDiff_Wave(k)] = BlandAltman(TDPhase(30:end-30),GWNWrappedPhase_Wave(:,k)',GraphicBA); 
end
